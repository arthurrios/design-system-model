...
import {
  ...
  SourceType,
  str
} from "./chunk-ULOKCXJB.js";
import {
  v
} from "./chunk-BI6SF4IK.js";
import {
  require_core_events
} from "./chunk-NVLE47E4.js";
import {
  stringify
...
} from "./chunk-LPB5FAZK.js";
import {
  require_uniq
} from "./chunk-P5L46KHL.js";
import {
  require_mapValues
} from "./chunk-XGEW6V6M.js";
import {
  require_pickBy
} from "./chunk-TEA2SVHR.js";
import {
  require_cloneDeep
} from "./chunk-Q6CZMOLT.js";
import {
  renderElement,
  unmountElement
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = scope, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-K43V7OPP.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-3YIJY6X7-JLKABWVY.js"));
...
//# sourceMappingURL=chunk-CBCR4P5L.js.map
